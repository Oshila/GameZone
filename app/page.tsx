...
const Homepage = () => {
  ...
  const WHATSAPP_COMMUNITY = "https://chat.whatsapp.com/HYk6KEfOTCrC8FwL9MAw2E"; // Replace with your actual link
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Community Section */}
      <section id="community" className="py-20 px-4 bg-gradient-to-br from-purple-50 via-blue-50 to-white">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="p-12 text-white">
                ...
                <h2 className="text-4xl md:text-5xl font-bold mb-6">
                  Connect With
                  <br />
                  <span className="text-yellow-300">5,000+ Gamers</span>
                </h2>
                <p className="text-xl text-purple-100 mb-8 leading-relaxed">
                  Join our exclusive WhatsApp community to connect with fellow gamers, get tournament updates, share strategies, and never miss an event!
                </p>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-lg mb-1">Real-time Updates</h4>
                      <p className="text-purple-100">Get instant notifications about new tournaments and events</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="bg-white/20 p-2 rounded-lg mt-1">
                    ...
                    <div>
                      <h4 className="font-semibold text-lg mb-1">Pro Tips & Strategies</h4>
                      <p className="text-purple-100">Learn from experienced players and improve your game</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="bg-white/20 p-2 rounded-lg mt-1">
                    ...
                    <div>
                      <h4 className="font-semibold text-lg mb-1">Exclusive Deals</h4>
                      <p className="text-purple-100">Access special discounts and early bird registrations</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="bg-white/20 p-2 rounded-lg mt-1">
                    ...
                    <div>
                      <h4 className="font-semibold text-lg mb-1">Find Teammates</h4>
                      <p className="text-purple-100">Connect with players and build your dream team</p>
                    </div>
                  </div>
                </div>
                ...
                <a
                  ...
                  className="inline-flex items-center gap-3 bg-white text-purple-600 px-8 py-4 rounded-xl font-bold text-lg hover:shadow-2xl transition transform hover:scale-105"
                >
              ...
              <div className="relative h-full min-h-[500px] hidden md:block">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-l from-transparent to-purple-600/50"></div>
                
                {/* Floating Elements */}
                <div className="absolute top-8 right-8 bg-white text-purple-600 p-4 rounded-2xl shadow-2xl transform rotate-6 hover:rotate-3 transition">
                  <Trophy className="w-8 h-8 mb-2" />
                  <div className="font-bold text-2xl">5,000+</div>
                  <div className="text-sm">Active Members</div>
                </div>
                
                <div className="absolute bottom-8 right-8 bg-yellow-400 text-gray-900 p-4 rounded-2xl shadow-2xl transform -rotate-6 hover:-rotate-3 transition">
                  <Zap className="w-8 h-8 mb-2" />
                  <div className="font-bold text-2xl">24/7</div>
                  <div className="text-sm">Active Chat</div>
                </div>
              </div>
            </div>
          </div>
